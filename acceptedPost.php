...
<body>
  <div class="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="acceptedPost.php" class="active">
            <i class='bx bx-box' ></i>
  ...
  <section class="home-section">
    ...
    <?php
      ...
      $sql = "SELECT * FROM property WHERE property_status='A' AND agent_id=$agentId";
      $stmt= $con->query($sql);
      $count=1;
      ?>
              ...
              ?>
                <tr>
                  ...
                  <td style="width: 150px;">
                    <form action="acceptedProperty_edit.php" method="post" style="display: inline; float: left; margin-right: 5px;">
                        <input type="hidden" name="property_id" value="<?php echo $result['property_id'];?>">
                        <input type="submit" style="width: 45px;" name="editAcceptedProperty" value="Edit">
                      </form>
                      <form action="DBconnect.php" method="post">
                        <input type="hidden" name="property_id" value="<?php echo $result['property_id'];?>">
                        <input type="submit" name="rentProperty" value="Rent">
                      </form>
                  </td>
                </tr>
