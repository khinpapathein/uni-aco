    ...
    <div class="home-content">
      <div class="overview-boxes">
        <?php 
          ...
          $psql="SELECT COUNT(property_id) FROM property WHERE property_status='P'";
          $pstmt=$con->query($psql);
          $pcount=$pstmt->fetchColumn();

          $dsql="SELECT COUNT(property_id) FROM property WHERE property_status='D'";
          $dstmt=$con->query($dsql);
          $dcount=$dstmt->fetchColumn();

          $rsql="SELECT COUNT(property_id) FROM property WHERE property_status='R'";
          $rstmt=$con->query($rsql);
          $rcount=$rstmt->fetchColumn();

          $asql="SELECT COUNT(property_id) FROM property WHERE property_status='A'";
