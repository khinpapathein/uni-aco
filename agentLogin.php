    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="AgentSignup.php">Login</a>
          </li>
        </ul>
      </div>
  ...
  <main id="main">
    <div id="login">
      <form action="agentLogin.php" method="post">
        Email: <input type="text" name="email" required="" class="form-control"><br><br>
        Password: <input type="password" name="password" required="" class="form-control"><br><br>
        <input type="submit" name="agentLogin" value="login" class="loginBtn">
        <input type="reset" value="clear" class="loginBtn">
        
      </form>

      <p style="font-size: 15px; padding-top: 10px;">Don't have account? <a href="agentSignup.php"> signup</a></p>
    </div>
