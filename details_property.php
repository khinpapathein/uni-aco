<?php 
  if(isset($_POST['detailsProperty'])){
    ...
    <?php
      ...
      ?>
        ...
        <form action="DBconnect.php" method="post" enctype="multipart/form-data">
          ...
          Photo:<input type="file" name="image" class="form-control" required value="<?php echo $result['photo'];?>"><br>
          
          <input type="submit" name="update_acceptedproperty" value="Update">
